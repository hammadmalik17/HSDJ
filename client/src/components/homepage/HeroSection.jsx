        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[80vh]">
          ...
          <div className={`space-y-8 transform transition-all duration-1000 ${
            ...
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20">
              ...
              <span className="text-white text-sm font-medium">Real Estate Platform 2024</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="group flex items-center justify-center space-x-2 bg-white text-blue-600 px-8 py-4 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
              ...
              <button 
                ...
                className="group flex items-center justify-center space-x-2 bg-transparent border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-blue-600 transition-all duration-300"
              >
            ...
            <div className="flex flex-wrap gap-8 pt-8">
              ...
              <div className="text-center">
                <div className="text-3xl lg:text-4xl font-bold text-white">$2.5B+</div>
